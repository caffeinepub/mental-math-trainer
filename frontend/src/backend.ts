...
import type { Operation as _Operation, Problem as _Problem } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async generateProblem(): Promise<Problem> {
        if (this.processError) {
            try {
                const result = await this.actor.generateProblem();
                return from_candid_Problem_n1(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
...
function from_candid_Operation_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Operation): Operation {
    return from_candid_variant_n4(_uploadFile, _downloadFile, value);
}
function from_candid_Problem_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Problem): Problem {
...
function from_candid_record_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        operation: from_candid_Operation_n3(_uploadFile, _downloadFile, value.operation)
    };
}
function from_candid_variant_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "subtraction" in value ? Operation.subtraction : "division" in value ? Operation.division : "addition" in value ? Operation.addition : "multiplication" in value ? Operation.multiplication : value;
}
